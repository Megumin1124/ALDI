...
if __name__ == '__main__':
    ...
    print('start')
    img_path =  '../datasets/sim10k/VOC2012/JPEGImages/'
    #img_path =  '../datasets/sim10k_SCG/VOC2012/JPEGImages/'
    save_path = '../datasets/sim10k_SCG/VOC2012/JPEGImages'
